...
static struct lwm2m_engine_obj_field fields[] = {
	OBJ_FIELD(ON_OFF_RID, RW, BOOL),
	OBJ_FIELD(LEVEL_RID, RW, FLOAT64),
	OBJ_FIELD(DELAY_DURATION_RID, RW_OPT, FLOAT64),
	OBJ_FIELD(MINIMUM_OFF_TIME_RID, RW, FLOAT64),
	OBJ_FIELD(FREQUENCY_RID, RW, FLOAT32),
	OBJ_FIELD(APPLICATION_TYPE_RID, RW_OPT, STRING),
	OBJ_FIELD(DIGITAL_INPUT_STATE_RID, R, BOOL),
};
...
static struct lwm2m_engine_obj_inst *buzzer_create(uint16_t obj_inst_id)
{
	...
	INIT_OBJ_RES_DATA(FREQUENCY_RID, res[avail], i, res_inst[avail], j,
