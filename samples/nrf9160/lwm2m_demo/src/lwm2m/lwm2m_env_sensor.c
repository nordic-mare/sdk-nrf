...
static struct float32_value gas_resistance_float = { 1000, 500000 };	// TODO: find plausible default value

static char *temp_unit = "C";
static char *press_unit = "kPa";
static char *humid_unit = "%";
static char *gas_resistance_unit = "Ohm";
			  ...
			  size_t *data_len)
{
	 ...
	 * failures to the LWM2M engine.
	 */
	read_enviroment_sensor(die_dev, gas_resistance_unit, SENSOR_CHAN_GAS_RES, &gas_resistance_float);
#endif
	lwm2m_engine_set_float32("3300/0/5700", &gas_resistance_float);
