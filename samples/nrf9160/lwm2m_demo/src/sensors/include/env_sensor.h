 ...
 * 
 * @param[out] press_val Pointer to sensor_value struct where the air pressure value is stored. 
 * @return int 0 if successful, negative error code if not.
 */
 ...
 * 
 * @param[out] humid_val Pointer to sensor_value struct where the air humidity value is stored. 
 * @return int 0 if successful, negative error code if not.
 */
 ...
 * 
 * @param[out] gas_res_val Pointer to sensor_value struct where the gas resistance value is stored. 
 * @return int 0 if successful, negative error code if not.
 */
