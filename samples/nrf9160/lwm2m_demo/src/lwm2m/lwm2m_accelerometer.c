...
static void set_timestamp(void)
{
	...
	lwm2m_engine_set_s32(LWM2M_PATH(IPSO_OBJECT_ACCELEROMETER_ID, 0, TIMESTAMP_RID), ts);
}
#endif
...
int lwm2m_init_accel(void)
{
	...
	lwm2m_engine_set_res_data(LWM2M_PATH(IPSO_OBJECT_ACCELEROMETER_ID, 0, APPLICATION_TYPE_RID),
